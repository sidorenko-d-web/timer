...
// node_modules/cubing/dist/esm/chunk-IJP4IAGZ.js
...
var Commutator = (_a2 = class extends AlgCommon {
  ...
  invert() {
    return new Commutator(__privateGet(this, _B), __privateGet(this, _A));
  }
...
var Conjugate = (_a3 = class extends AlgCommon {
  ...
  invert() {
    return new Conjugate(__privateGet(this, _A2), __privateGet(this, _B2).invert());
  }
...
var LineComment = (_a4 = class extends AlgCommon {
  ...
  isIdentical(other) {
    ...
    return other.is(LineComment) && __privateGet(this, _text) === __privateGet(otherAsLineComment, _text);
  }
  invert() {
    return this;
  }
...
var QuantumMove = (_a6 = class extends Comparable {
  ...
  modified(modifications) {
    return new QuantumMove(modifications.family ?? __privateGet(this, _family), modifications.innerLayer ?? __privateGet(this, _innerLayer), modifications.outerLayer ?? __privateGet(this, _outerLayer));
  }
  isIdentical(other) {
    const otherAsQuantumMove = other;
    return other.is(QuantumMove) && __privateGet(this, _family) === __privateGet(otherAsQuantumMove, _family) && __privateGet(this, _innerLayer) === __privateGet(otherAsQuantumMove, _innerLayer) && __privateGet(this, _outerLayer) === __privateGet(otherAsQuantumMove, _outerLayer);
  }
  get family() {
...
var Move = (_a7 = class extends AlgCommon {
  ...
  invert() {
    return transferCharIndex(this, new Move(__privateGet(this, _quantumWithAmount).quantum, -this.amount));
  }
  *experimentalExpand(iterDir = 1) {
  ...
  modified(modifications) {
    return new Move(__privateGet(this, _quantumWithAmount).quantum.modified(modifications), modifications.amount ?? this.amount);
  }
  static fromString(s) {
    return parseMove(s);
  }
...
var Grouping = (_a8 = class extends AlgCommon {
  ...
  isIdentical(other) {
    ...
    return other.is(Grouping) && __privateGet(this, _quantumWithAmount2).isIdentical(__privateGet(otherAsGrouping, _quantumWithAmount2));
  }
  get alg() {
  ...
  invert() {
    return new Grouping(__privateGet(this, _quantumWithAmount2).quantum, -__privateGet(this, _quantumWithAmount2).amount);
  }
  *experimentalExpand(iterDir = 1, depth) {
    depth ?? (depth = Infinity);
    if (depth === 0) {
...
}, _quantumWithAmount2 = new WeakMap(), _a8);
...
function experimentalAppendMove(alg, addedMove, options) {
  ...
  if (optionsHelper.cancelAny()) {
    ...
    if (axis) {
      outputSuffix = axis.simplifySameAxisMoves(suffix, optionsHelper.cancelPuzzleSpecificModWrap() !== "none");
    } else {
      let amount = suffix.reduce((sum, move) => sum + move.amount, 0);
      if (quantumDirections.size !== 1) {
        throw new Error("Internal error: multiple quantums when one was expected");
      }
...
var Simplify = (_a9 = class extends TraversalDownUp {
  ...
  *traverseAlg(alg, options) {
    ...
    for (const algNode of alg.childAlgNodes()) {
      for (const traversedNode of this.traverseAlgNode(algNode, newOptions)) {
        output = Array.from(experimentalAppendNode(new Alg(output), traversedNode, newOptions).childAlgNodes());
      }
    }
  ...
  *traverseGrouping(grouping, options) {
    ...
    const newGrouping = new Grouping(this.traverseAlg(grouping.alg, __privateMethod(this, _descendOptions, descendOptions_fn).call(this, options)), grouping.amount);
...
var Alg = (_a10 = class extends AlgCommon {
  ...
  invert() {
    return new Alg(reverse(Array.from(__privateGet(this, _algNodes)).map((u) => u.invert())));
  }
  *experimentalExpand(iterDir = 1, depth) {
    depth ?? (depth = Infinity);
  ...
  expand(options) {
    return new Alg(this.experimentalExpand(1, options?.depth ?? Infinity));
  }
  *experimentalLeafMoves() {
  ...
  concat(input) {
    return new Alg(Array.from(__privateGet(this, _algNodes)).concat(Array.from(toIterable(input))));
  }
  experimentalIsEmpty() {
